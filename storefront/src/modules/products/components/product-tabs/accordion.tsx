...
const MorphingTrigger = () => {
  return (
    <div className="text-ui-fg-base hover:bg-ui-bg-subtle active:bg-ui-bg-subtle active:text-ui-fg-interactive focus-visible:shadow-borders-interactive-with-active disabled:text-ui-fg-disabled bg-transparent disabled:bg-transparent rounded-rounded group relative p-[6px]">
